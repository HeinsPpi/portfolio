...
const projectHighlights = {
  ...
  'utokyo-gsc-next': {
    role: 'メンターの先生方から助言・指導を受けながら、自ら研究テーマを設定し、先行研究調査からデータ整理、AIモデルの開発・検証まで取り組んだ。',
    outcome: 'カーリングの試合データをもとに、盤面や試合状況から戦略的な有利・不利を推定するAIモデルを開発。試行錯誤を重ねながら、盤面生成型から価値推定型へとアプローチを転換した。',
    learning: 'うまくいかない結果をそのまま失敗とせず、原因を分解し、問いや手法を組み替えて検証し直すことの重要性を学んだ。',
  },
  'wro-2024': {
